...
/** 
    ...
    ****Note - for ROBI we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of robi coming in to a transaction
