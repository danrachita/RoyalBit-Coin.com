...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ROBI features */
        {"robi", "masternode", &masternode, true, true, false},
        {"robi", "masternodelist", &masternodelist, true, true, false},
        {"robi", "mnbudget", &mnbudget, true, true, false},
        {"robi", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"robi", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"robi", "mnsync", &mnsync, true, true, false},
        {"robi", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"robi", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use robid, or the -server option to robi-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> robi-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9898/\n";
}
