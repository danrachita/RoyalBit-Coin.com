...
In order to support loading of multiple wallets in robi-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is robi.cpp.
...
Changes to robi.cpp
----------------------
robi.cpp is the entry point into robi-qt, and as such, will require some minor modifications to provide hooks for
